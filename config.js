...
module.exports = {
    ...
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://telegra.ph/file/bd7b21af216760783818b.jpg' : process.env.ALIVE_LOGO,
    KICKMEMSG: process.env.KICKME_MESSAGE === undefined ? 'default' : process.env.KICKME_MESSAGE,
    BLOCKCHAT: process.env.BLOCK_CHAT === undefined ? false : process.env.BLOCK_CHAT,
    WELCOME: process.env.WELCOME === undefined ? 'pp' : process.env.WELCOME,
    OWNER: process.env.OWNER_NAME === undefined ? 'Ravana-Sl-Team' : process.env.OWNER_NAME,
    CP_TEXT: process.env.CP_TEXT === undefined ? 'ʍǟɖɛ ɮʏ ʀǟʋǟռǟ ȶɦɛ ɮօȶ 𓂀 𝕝𝕖𝕘𝕖𝕟𝕕 𝕓𝕠𝕥 𝕠𝕗 𝕤𝕣𝕚 𝕝𝕒𝕟𝕜𝕒 𓂀' : process.env.CP_TEXT,
    SONG_UP: process.env.SONG_UP === undefined ? 'v4.5 ᴜᴘʟᴏᴀᴅɪɴɢ' : process.env.SONG_UP,
    VIDEO_DOWN: process.env.VIDEO_DOWN === undefined ? 'v4.5 ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ' : process.env.VIDEO_DOWN,
    VID_CP: process.env.VID_CP === undefined ? '♣💎  Ř𝕒V𝓪Ｎ𝐚 𝔂ŤⒹ𝕃  ♜✌' : process.env.VID_CP,
    VIDEO_UP: process.env.VIDEO_UP === undefined ? 'v4.5 ᴜᴘʟᴏᴀᴅɪɴɢ' : process.env.VIDEO_UP,
    ...
    SONG_D: process.env.SONG_D === undefined ? 'v4.5 ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ' : process.env.SONG_D,
    ...
    MENU_LOGO: process.env.MENU_LOGO === undefined ? 'https://telegra.ph/file/3a80350cf98643ef6026c.jpg' : process.env.MENU_LOGO,
    BRANCH: 'master',
    HEROKU: {
