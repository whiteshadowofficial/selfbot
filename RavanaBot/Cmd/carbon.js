...
if (Config.WORKTYPE == 'private') {
    ...
    Raone.useCmd({pattern: 'carbon$', fromMe: true, desc: Lang.CARBON_DESC}, (async (message, match) => {
    ...
    Raone.useCmd({pattern: 'carbon$', fromMe: false, desc: Lang.CARBON_DESC}, (async (message, match) => {
