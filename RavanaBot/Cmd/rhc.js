...
const HELP = "Bot help Center"
    ...
    RAVANA.useCmd({pattern: 'rhelp', fromMe: true, deleteCommand: true, desc: HELP,}, (async (message, match) => {
    ...
    RAVANA.useCmd({pattern: '1', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    RAVANA.useCmd({pattern: '2', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    
        await message.sendMessage("*කරුණාකර ඔබගේ බොට්ව restart කරන්න.* \n\n .restart \n\n🥰Thank you for using RAVANA HELP CENTER🇱🇰");
    
    }));
    RAVANA.useCmd({pattern: '3', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    RAVANA.useCmd({pattern: '7', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    
        await message.sendMessage("*බොට් හට .ravana හෝ .help ගසන්න.*\n\n🥰Thank you for using RAVANA HELP CENTER🇱🇰");
    
    }));
    RAVANA.useCmd({pattern: '8', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    RAVANA.useCmd({pattern: '9', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    RAVANA.useCmd({pattern: '10', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    RAVANA.useCmd({pattern: '11', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
