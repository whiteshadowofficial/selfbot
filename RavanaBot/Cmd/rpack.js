...
const Make = "ඔබගේ ලොගෝ එක සාදමින් පවතී...⚙"
...
await message.client.sendMessage(message.jid,Make,MessageType.text);
...
const buttons = [
          {buttonId: 'Good', buttonText: {displayText: 'ඔව්❤'}, type: 1},//jakakkak
         {buttonId: 'Bad', buttonText: {displayText: 'නෑ💔'}, type: 1},
 ]

 const gb = {

    contentText: "ලොගෝ එක හොදද?",
    ...
    headerType: 1
        ...
        await message.client.sendMessage (message.jid, gb, MessageType.buttonsMessage)
