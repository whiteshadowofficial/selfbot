...
RAVANA.useCmd({ pattern: '4', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
...
RAVANA.useCmd({ pattern: '5', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
...
RAVANA.useCmd({ pattern: '6', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
