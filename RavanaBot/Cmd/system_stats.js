...
if (Config.ALIVE_IMG_TYPE == 'pp') {
    ...
    Raone.useCmd({pattern: 'alive', fromMe: rn, desc: Lang.ALIVE_DESC}, (async (message, match) => {
    ...
    Raone.useCmd({pattern: 'sysd', fromMe: rn, desc: Lang.SYSD_DESC}, (async (message, match) => {
